    ...
    <div class="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg">
      ...
      <form @submit.prevent="handlerLogin" class="space-y-4">
        ...
        <div>
          ...
          <input v-model="credencials.email" type="email" placeholder="correo@ejemplo.com"
        ...
        <div>
          ...
          <input v-model="credencials.password" type="password" placeholder="••••••••"
            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required />
        </div>
...
const handlerLogin = () => {
  authStore.login(credencials.value)
