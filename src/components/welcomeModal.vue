  ...
  >
    <div class="bg-white dark:bg-gray-800 rounded-2xl sh1adow-xl w-full max-w-lg p-8">
      ...
      <div class="mt-6 text-sm">
        <p :class="passwordRules.length ? 'text-green-600' : 'text-gray-500'">✓ 8 caracteres</p>

        <p :class="passwordRules.upper ? 'text-green-600' : 'text-gray-500'">✓ Una mayúscula</p>

        <p :class="passwordRules.lower ? 'text-green-600' : 'text-gray-500'">✓ Una minúscula</p>

        <p :class="passwordRules.number ? 'text-green-600' : 'text-gray-500'">✓ Un número</p>
